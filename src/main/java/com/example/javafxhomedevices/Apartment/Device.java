...
public class Device implements Serializable {
    ...
    public static class ApartmentMain {

        private static Apartment apartment;
        private static ArrayList<Room> allRooms;
        private static ArrayList<Socket> allSockets;
        private static ArrayList<Device> allDevices;
        private static String fileName;
        static final String apartmentName = "SpaceShip";
        ...
        *
        * */
        private static void startMenu(String[] options){
         ...
         * */
        private static void saveConfig(Scanner scanner){
         ...
         * */
        private static void loadConfig(Scanner scanner){
        ...
        * */
        private static void addSocket(Scanner scanner){
            if(allRooms.isEmpty()) {
         ...
         * */
        private static void showSockets(){
         ...
         * */
        private static void turnOnDevice(Scanner scanner){
         ...
         * @param scanner contains device name to turn on
         * */
        private static void turnOffDevice(Scanner scanner){
         ...
         * */
        private static void calculateTotalPower(){
            if(!allDevices.isEmpty()){
         ...
         * @return device
         * */
        private static void findDeviceByInput(Scanner scanner){
            if(!allDevices.isEmpty()){
         ...
         * @return socket
         * */
        private static Socket findSocket(String name){
            if (allSockets.isEmpty()) {
                System.out.println("No sockets detected. \n");
            } else {
                for (Socket socket : allSockets){
         ...
         * */
        private static void showFreeSockets(){
            for(Socket socket: allSockets){
                if(socket.getDevice() == null){
                    System.out.println("\t" + socket);
                }
         ...
         * */
        private static Device getDeviceByFullName(String deviceName){
            for (Device device : allDevices){
         ...
         * @param room which sockets we want to see
         * */
        private static void showEnabledDevices(){
            for (Device device : allDevices){
                if (device.getIsOn()){
                    System.out.println(device);
                }
         ...
         * @param room which sockets we want to see
         * */
        private static void showDisabledDevices(){
            for (Device device : allDevices){
                if (!device.getIsOn()){
                    System.out.println(device);
                }
         ...
         * @return counter
         * */
        private static int enabledDeviceAmount(){
            int counter = 0;
            for (Device device : allDevices){
                if (device.getIsOn()){
                    counter++;
         ...
         * @return counter
         * */
        private static int disabledDeviceAmount(){
            int counter = 0;
            for (Device device : allDevices){
                if (!device.getIsOn()){
                    counter++;
